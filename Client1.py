...
image_dir = 'Dataset_Processed/Client 1/images'
...
preprocessed_masks=preprocessed_masks.reshape(950, 256,256,1)
...
results1 = model1.train(data="Dataset_Processed/Client 1/Yolo Format/detect.yaml", epochs=70)
...
for i in range(num_images):
    ...
    plt.axis('off')
    plt.show()
    str1="Actual Image Client1"+str(i)+".png"
    plt.savefig(str1)
    ...
    plt.axis('off')
    plt.show()
    str1="Mask Image Client1"+str(i)+".png"
    plt.savefig(str1)
    ...
    plt.axis('off')    
    plt.show()
    str1="Predicted mask Client1"+str(i)+".png"
    plt.savefig(str1)    
